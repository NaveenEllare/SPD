            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
               <ul class="nav navbar-nav">
                  ...
                  <li class="menu-item-has-children dropdown">
                     <a href="check_order.php" > ORDERS</a>
                  </li>
                  <li class="menu-item-has-children dropdown">
                     <a href="admin_product.php" > STOCKS</a>
                  </li>
                  <li class="menu-item-has-children dropdown">
				  ...
				  <li class="menu-item-has-children dropdown">
                     <a href="contact_us.php" > SUPPLIERS</a>
                  </li>
         ...
         <header id="header" class="header">
            <div class="top-left">
               <div class="navbar-header">
                  ...
                  <a class="navbar-brand hidden" href="index.php"><img src="image/logo2.png" alt="Logo"></a>
